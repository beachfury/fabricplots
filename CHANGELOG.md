...
The safety and reliability update for Minecraft 26.2.
...
- **Runtime loading metadata.** FabricPlots remains server-side in behavior but initializes on both dedicated
  servers and integrated single-player servers. This branch targets Minecraft `~26.2`, Java 25 and Java 25
