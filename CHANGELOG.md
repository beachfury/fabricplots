...
The safety and reliability update for Minecraft 1.21.1.
...
- **Runtime loading metadata.** FabricPlots remains server-side in behavior but initializes on both dedicated
  servers and integrated single-player servers. This branch targets Minecraft `~1.21.1`, Java 21 and Java 25
